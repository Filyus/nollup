...
let { isAsyncErrorHandler, triggerAsyncErrorListener, hasErrorThrownAlready, setErrorThrownAlready } = require('./ErrorHandling');
...
module.exports = {
    ...
    create (context, plugin) {
        return {
            ...
            error (e) {
                if (!hasErrorThrownAlready()) {
                    setErrorThrownAlready();
                    if (isAsyncErrorHandler()) {
                        triggerAsyncErrorListener(e);
                    } else {
                        if (typeof e === 'string') {
                            throw new Error(e);
                        } else {
